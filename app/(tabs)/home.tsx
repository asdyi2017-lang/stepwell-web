import { Activity, AlertTriangle, Droplets, HeartPulse, Stethoscope, LogOut, Watch, WifiOff, Pencil, MessageCircle, Send, Download, Sun, Footprints, Flame, Zap, Award, BarChart2, X, Share2, Heart, Target, Settings, ChevronRight, Check } from 'lucide-react-native';
          ...
          {page === 'profile' ? (
            <ScrollView contentContainerStyle={{ paddingBottom: 24, gap: 20 }} showsVerticalScrollIndicator={false}>
              <View style={styles.profileCard}>
                <Image source={{ uri: "https://avatars.mds.yandex.net/get-yapic/69015/3vULTgBvet3oDps8eGudxrUec-1/orig" }} style={styles.profileBigAvatar} />
                <View style={{flex: 1}}>
